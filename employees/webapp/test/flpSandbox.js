		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "employees",
									"targetURL": "#Antonioemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Antonioemployees-display": {
								"semanticObject": "Antonioemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Antonio.employees",
									"url": sap.ui.require.toUrl("Antonio/employees")
								}
							}
						}
					}
