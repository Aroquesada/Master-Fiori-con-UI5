		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Types",
									"targetURL": "#Antoniolists-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Antoniolists-display": {
								"semanticObject": "Antoniolists",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Antonio.lists",
									"url": sap.ui.require.toUrl("Antonio/lists")
								}
							}
						}
					}
